...
public class ImageGenerationExample {
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        String input =
                "A bunch of people are standing in a field. They are wearing colorful clothes and holding"
                        + " umbrellas.";
        var response =
                client.images.generate(
                        r ->
                                r.model(ImageGenerationRequest.Model.DALL_E_3)
                                        .quality(ImageGenerationRequest.Quality.HD)
                                        .prompt(input)
